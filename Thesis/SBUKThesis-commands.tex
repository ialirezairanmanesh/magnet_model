...
% تنظیمات استایل‌های تایتل‌ها مطابق فرمت نگارش پایان‌نامه
% استایل فصل
\titleformat{\chapter}[display]
{\fontsize{16}{18}\selectfont\bfseries\centering}
...
\definecolor{myblackcolor}{HTML}{000000}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% بسته‌ و دستوراتی برای ایجاد لینک‌های رنگی با امکان جهش
\usepackage[colorlinks=true,linkcolor=myblackcolor,urlcolor=myblackcolor,citecolor=myblackcolor,filecolor=myblackcolor,menucolor=myblackcolor,runcolor=myblackcolor]{hyperref}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\defpersianfont\titr[Scale=1]{B Zar Bold}
...
\renewcommand{\cfttoctitlefont}{\fontsize{16pt}{18pt}\selectfont\bfseries} %% فهرست مطالب
\renewcommand{\cftaftertoctitle}{}

\renewcommand{\cftloftitlefont}{\fontsize{16pt}{18pt}\selectfont\bfseries} %% فهرست اشکال
\renewcommand{\cftafterloftitle}{}

\renewcommand{\cftlottitlefont}{\fontsize{16pt}{18pt}\selectfont\bfseries} %% فهرست جداول
\renewcommand{\cftafterlottitle}{}
%فهرست الگوریتم ها
\renewcommand{\listalgorithmname}{\vspace{-2.7cm}\fontsize{16}{18}\selectfont\bfseries\centering فهرست الگوریتم‌ها}
